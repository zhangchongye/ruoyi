...
import com.ruoyi.test.service.ITeacherService;
...
public class TeacherController extends BaseController
{
     ...
     * 查询teacher列表
     */
    @PreAuthorize("@ss.hasPermi('test:teacher:list')")
    @GetMapping("/list")
     ...
     * 导出teacher列表
     */
    @PreAuthorize("@ss.hasPermi('test:teacher:export')")
     ...
     * 获取teacher详细信息
     */
    @PreAuthorize("@ss.hasPermi('test:teacher:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增teacher
     */
    @PreAuthorize("@ss.hasPermi('test:teacher:add')")
     ...
     * 修改teacher
     */
    @PreAuthorize("@ss.hasPermi('test:teacher:edit')")
     ...
     * 删除teacher
     */
    @PreAuthorize("@ss.hasPermi('test:teacher:remove')")
